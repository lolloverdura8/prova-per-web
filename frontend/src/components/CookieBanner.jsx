...
import { FaCog, FaMoon, FaSun, FaBell, FaBellSlash, FaCookie } from 'react-icons/fa';
...
const UserSettings = () => {
  ...
  const clearCookiePreferences = () => {
    ...
    setPreferences(getUserPreferences());
    alert("Preferenze cookie cancellate con successo!");
  };
      ...
      {showSettings && (
        <div className="settings-panel">
          ...
          <div className="cookie-management">
            ...
            >
              <FaCookie style={{ marginRight: '8px' }} /> Cancella preferenze
            </button>
          </div>
        </div>
      )}
